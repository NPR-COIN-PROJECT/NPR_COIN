...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun May 20 08:44:28 2018
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/NEPLEASECOIN/src/leveldb/libleveldb.a /tmp/NEPLEASECOIN/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
/tmp/NEPLEASECOIN/src/leveldb/libleveldb.a: FORCE
	cd /tmp/NEPLEASECOIN/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a
